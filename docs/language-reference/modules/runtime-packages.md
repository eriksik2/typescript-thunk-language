...
|---|---|---|
| `@thunk/runtime` | Authors (explicit) | `use`, `provide`, `layerOf`, `mergeLayers`, `wrap`, `symbolOf`, `symbolIs`, `symbolExtends`, `Symbol`, Failure hierarchy (`Failure`, `Defect`, `UnhandledError`, `Error`) |
